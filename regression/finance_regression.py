...
"""
"""                            output type       what are you trying to find?     evaluation
    Supervised classification: discrete             decision boundary             accuracy
    Regression:                continuous           "best fit line"               "sum of squared error" or R-squared
"""
...
print(reg.coef_, reg.intercept_, score_train, score_test)
